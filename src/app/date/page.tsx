    ...
    <Container className="py-10">
      ...
      {todayBs && (
        <div className="mt-7 rounded-xl border border-[var(--color-line)] bg-[var(--color-surface)] px-5 py-4 max-w-2xl">
          <div className="text-[11.5px] uppercase tracking-wider text-[var(--color-ink-3)]">Today in Nepal</div>
          <div className="text-[22px] font-semibold tracking-tight mt-1">{formatBs(todayBs)}</div>
          <div className="ne text-[16px] text-[var(--color-ink-2)]">{formatBs(todayBs, 'ne')}</div>
          <div className="text-[13.5px] text-[var(--color-ink-3)] mt-1.5">
      ...
      {spans.length > 0 && (
        <section className="mt-12 max-w-2xl">
          ...
          <p className="text-[13.5px] text-[var(--color-ink-3)] mb-4">
            ...
            <strong className="text-[var(--color-ink-2)]">unconfirmed</strong> until someone checks the
